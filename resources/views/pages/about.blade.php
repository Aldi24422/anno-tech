...
@section('content')
    ...
    <div class="container mx-auto px-4 pt-32 pb-20 max-w-5xl">
        ...
        <div class="bg-cream border-4 border-navy rounded-xl shadow-[8px_8px_0_#2D336B] p-6 md:p-10 mb-12 relative overflow-hidden"
            data-tilt>

            <div
                class="absolute top-4 right-4 bg-red-500 text-white font-pixel px-3 py-1 rounded border-2 border-navy text-sm transform rotate-3">
                PLAYER_1
            </div>
            ...
            <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                ...
                <div class="relative group">
                    <div
                        class="w-40 h-40 md:w-56 md:h-56 bg-softblue border-4 border-navy rounded-xl overflow-hidden shadow-[6px_6px_0_rgba(45,51,107,0.3)] group-hover:scale-105 transition-transform">
                        <img src="https://api.dicebear.com/7.x/pixel-art/svg?seed=Aldi&backgroundColor=b6e3f4"
                            alt="Profile Avatar" class="w-full h-full object-cover pixelated">
                    </div>
                    <div
                        class="absolute -bottom-4 -right-4 bg-navy text-cream font-pixel px-4 py-1 rounded border-2 border-cream shadow-md">
                        LVL. 99
                    </div>
                </div>
                ...
                <div class="flex-1 text-center md:text-left">
                    ...
                    <p class="font-body text-navy leading-relaxed mb-6">
                        ...
                        Spesialisasi saya adalah membantu mahasiswa survive dari Skripsi dan membantu bisnis go-digital
                        dengan aplikasi yang efisien."
                    </p>
        ...
        <div class="bg-navy text-cream border-4 border-periwinkle rounded-xl p-8 text-center relative overflow-hidden">
            ...
            <a href="https://wa.me/6285117776959"
                class="inline-block bg-periwinkle text-white font-pixel text-xl px-8 py-3 rounded-lg border-2 border-white shadow-[4px_4px_0_#000] hover:scale-105 hover:bg-cream hover:text-navy transition-all relative z-10">
